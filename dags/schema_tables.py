...
schema_tabela = SparkSubmitOperator(
    task_id="schema_tabela",
    application="jobs/schema_tabela.py",
    name=spark_app_name,
    conn_id=spark_conn,
    verbose=1,
    conf = {
