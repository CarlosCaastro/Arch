...
spark_app_name = "BRONZE_TO_SILVER"
now = datetime.now()
...
dag = DAG(
    ...
    description="This DAG triggers a Spark job to process data from layer bronze of MinIO (Delta Lake) and write at layer silver in MinIO",
