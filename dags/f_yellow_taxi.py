...
f_yellow_taxi = SparkSubmitOperator(
    task_id="f_yellow_taxi",
    application="jobs/f_yellow_taxi.py",
    name=spark_app_name,
    conn_id=spark_conn,
    verbose=1,
    conf = {
